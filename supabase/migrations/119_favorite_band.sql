-- Migration 119: Lieblingsband getrennt vom Lieblingssong
-- (NUTZERWUNSCH): profile.favorite_band (neu) neben favorite_song.

ALTER TABLE public.profiles
  ADD COLUMN IF NOT EXISTS favorite_band text NOT NULL DEFAULT '';

COMMENT ON COLUMN public.profiles.favorite_band IS
'v0.9.2: Lieblingsband/-kuenstler (getrennt vom Lieblingssong).';

-- public_profiles-View (Basis: 115-Definition + favorite_band am Ende).
...
-- get_public_profile (Basis: 115) + favorite_band.
...
-- get_public_profiles (Basis: 115) + favorite_band.
